...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отчет.ДатаОкончания  = КонецДня(ТекущаяДатаСеанса());
...
Процедура СформироватьОтчетНаСервере()
	...
	ПараметрыОтчета.Вставить("ВидКонтрагента", ВидКонтрагента);
...
Процедура УстановитьПараметрыВыбора()
	...
	Если ВидКонтрагента = "Поставщик" Тогда
	...
	Элементы.Договор.ПараметрыВыбора = Новый ФиксированныйМассив(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(
		Новый ПараметрВыбора("Отбор.ВидДоговора", МассивВидовДоговоров)));
